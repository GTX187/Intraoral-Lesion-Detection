...
Augmentations needed to balance dataset:
  - OPMD      :  5 source images  -> ~20 augmentations per image
  - Variation : 30 source images  ->  ~120 augmentations per image
...
GEOMETRIC = [
    ...
    #     # Kept at ±8% (not ±10%) — larger scale changes push lesion polygons
